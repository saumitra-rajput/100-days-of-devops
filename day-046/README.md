...
c. Map php_web container's port 80 with host port 8087
...
services:
  web:
    ...
    environment:
      DB_HOST: db
      DB_NAME: database_apache
      DB_USER: banner
      DB_PASSWORD: Tes36*g1@
  ...
  db:
    ...
    environment:
      MARIADB_ROOT_PASSWORD: Rootcompl2lex@
      MARIADB_DATABASE: database_apache
      MARIADB_USER: banner
      MARIADB_PASSWORD: Tes36*g1@
    healthcheck:
...
above ss will fail due to docker-compose miss config
